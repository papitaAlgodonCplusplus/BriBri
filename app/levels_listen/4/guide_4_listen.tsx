...
const Guide4Listen = ({ navigation }: { navigation: NavigationProp<any> }) => {
  ...
  // These correspond to the level 4 draggable elements
  ...
  // Define audio box styles based on the drop zones from level 4
  ...
  const audioBoxesData = [
    { id: 1, name: 'kowolo', style: dropZoneStyles.zoneContainer1 },
    { id: 2, name: 'klowok', style: dropZoneStyles.zoneContainer2 },
    { id: 3, name: 'kochane', style: dropZoneStyles.zoneContainer3 },
    { id: 4, name: 'kokata', style: dropZoneStyles.zoneContainer4 },
  ];
